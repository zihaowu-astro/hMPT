...
1. Flexiable in-shutter criteria. We have two options: 1. source centering options as in MPT; 2. an in-shutter flux threshold that accounts for the PSF and source fluxes.
